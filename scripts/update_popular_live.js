...
const CONSOLIDATED_MEDIA_CHANNELS = [
  ...
  { name: "CTi News (中天新聞)", id: "UCwbtZfbZ6aasIDbmtEjuJOw", region: "TW", category: "News" },
  { name: "Sanlih E-Television (SET)", id: "UCVh-X_W6n64G6t-1k1q-w2A", region: "TW", category: "News" },
  { name: "WeatherNews (Japan)", id: "UCNos_DnXGkUeFzYQZc_hXMg", region: "JP", category: "Weather" },
];
...
function filterByRegion(streams, regionName) {
  const unwantedPatterns = {
    ...
    "TW": [
      ...
      "hindi", "urdu", "telugu", "tamil", "marathi", "bengali", "pakistan", "india", "big tv", "geo news"
    ],
    "KR": [
      "chinese", "中文", "japanese", "日本", "english", "arabic", "العربية",
      "hindi", "urdu", "telugu", "tamil", "marathi", "bengali", "pakistan", "india"
    ],
    "CN": [
